...
get_header(); ?>
    <section class="blog_header">
        <div class="container">
           ...
           <div>
                <h5 class="blog_date">Case Study | <?php the_time(
                  "F j, Y"
                ); ?></h5>
           </div>
    ...
    <section class="">
        <div class="container">
            <h2 class="heading europa-thin"><span>More <span class="europa-bold">Case Studies</span></span></h2>
    ...
    <section class="container">
        ...
        <div class="blog_more_studies_grid_btn">
            <button onclick="location.href='<?php the_permalink(97); ?>'" class="btn btn_clear btn_clear_secondary text-uppercase">View all case studies</button>
        </div>
        </section>
